...
// Spacing of the 3x3 filter taps in texels; each tap is a hardware 2x2 bilinear compare, so
// the penumbra is about 3 * radius + 1 texels wide (cascade 0 texels are ~1 world unit)
